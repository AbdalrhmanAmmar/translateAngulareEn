...
import { TranslationService } from '../../../../core/services/helper-services/translation.service';
...
@Component({
  ...
  imports: [ContainerComponent ,HeaderNavComponent, TooltipModule, HeaderTogglerDirective, SidebarToggleDirective, IconDirective, HeaderNavComponent, RouterLink, NgTemplateOutlet, BreadcrumbRouterComponent, DropdownComponent, DropdownToggleDirective, AvatarComponent, DropdownMenuDirective, DropdownHeaderDirective, DropdownItemDirective, BadgeComponent, DropdownDividerDirective, TranslateModule]
})
